...
function themesflat_customize_default($key) {
	$default = array(
		...
		'topbar_address_label' => '<i class="carenow-icon-map-marker-alt11"></i>',
		'topbar_address' => '2072 Pinnickinick Street, WA 98370',
		'topbar_email_label' => '<i class="carenow-icon-envelope1"></i>',
		'topbar_email' => 'info@website.com',
		'topbar_time_label' => '<i class="carenow-icon-clock1"></i>',
		...
		'bread_crumb_prefix' =>'',
		'breadcrumb_separator' =>  wp_kses( '<i class="carenow-icon-chevron-right"></i>', themesflat_kses_allowed_html() ),
