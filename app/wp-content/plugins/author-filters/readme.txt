=== Author Filters ===
Contributors: clarionwpdeveloper, yogeshdalavi
Tags: posts, pages, custom post types, author, sorting, filters
...
1. Screenshot overview to display author filters drop down on post listing page in admin panel.
