...
$title['en'] = array(
    ...
    "vatRate22" => "VAT 22%",
    "vatRate10" => "VAT 10%",
    "vatRateCalculated20_120" => "VAT rate calc. 20/120",
    "vatRateCalculated22_122" => "VAT rate calc. 22/122",
    "vatRateCalculated10_110" => "VAT rate calc. 10/110",
    "vatRate0" => "VAT 0%",
    "vatIsNotAppearing" => "VAT is not appearing",
    "vatRate5" => "VAT 5%",
    "vatRate7" => "VAT 7%",
    "vatRateCalculated5_105" => "VAT rate calc. 5/105",
    "vatRateCalculated7_107" => "VAT rate calc. 7/107",
);

$description['en'] = array(
    'eshopId' => "Can watch on htttp://lk.intellectmoney.ru site",
    ...
    'preference' => "Comma-separated list of payment ways available to customer by default. Possible values are: BankCard, YandexPay, Sbp. More information https://wiki.intellectmoney.ru/pages/viewpage.action?pageId=4849751",
    ...
    'holdTime' => "When using 'release Mode' responsible for the date of debiting. Specify in hours. The maximum value of 119 hours",
    ...
    'accountId' => "User account number on https://lk.intellectmoney.ru",
    'formId' => "The number of the form for receiving payments on https://lk.intellectmoney.ru",
