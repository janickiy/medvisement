...
var enhanceToggle = function enhanceToggle($field) {
  ...
  enhanceToggles = function enhanceToggles($container) {
    ...
    var $toggles = external_jQuery_default()('.yith-wcaf-toggle', $container).not('.enhanced');
    if (!$toggles.length) {
      return;
    }
...
var initFields = function initFields($container) {
  ...
  // password field
  (function () {
    var $password = external_jQuery_default()('input[type="password"]', $container);
    if (!$password.length) {
      return;
    }
    $password.each(function () {
      ...
      var $wrapper = external_jQuery_default()('<div/>', {
  ...
  // type field
  (function () {
    var $type = external_jQuery_default()('#invoice_type_field', $container);
    if (!$type.length || $type.hasClass('enhanced')) {
      return;
    }
    var cnt = 1;
    $type.addClass('enhanced').find('label').each(function () {
      var $label = external_jQuery_default()(this),
        $checkbox = $label.prev(),
  ...
  (function () {
    var $form = external_jQuery_default()('form', $container);
    if (!$form.length) {
      return false;
    }
    initValidation($form);
...
var YITH_WCAF_Modal = /*#__PURE__*/function () {
  ...
  _createClass(YITH_WCAF_Modal, [{
    ...
    value: function maybeBuildModal() {
      ...
      var $modal = external_jQuery_default()('<div/>', {
      ...
      if ((_this$args3 = this.args) !== null && _this$args3 !== void 0 && _this$args3.title) {
        var $title = external_jQuery_default()('<div/>', {
          "class": 'title',
...
var YITH_WCAF_Ajax_Submit_Modal = /*#__PURE__*/function (_YITH_WCAF_Modal) {
  ...
  _createClass(YITH_WCAF_Ajax_Submit_Modal, [{
    ...
    key: "maybeSubmitForm",
    value: function () {
      var _maybeSubmitForm = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee(ev) {
        var _this$args,
          _this2 = this;
...
var YITH_WCAF_Shortcodes = /*#__PURE__*/function () {
  ...
  _createClass(YITH_WCAF_Shortcodes, [{
    ...
    value: function initTooltips() {
      var $tooltips = external_jQuery_default()('[data-tip]', this.$container);
      if (!$tooltips.length) {
        return;
      }
    ...
    value: function initLinkGenerator() {
      var $linkGenerator = external_jQuery_default()('.link-generator', this.$container);
    ...
    value: function initSetReferrer() {
      var $setReferrer = external_jQuery_default()('.set-referrer-wrapper', this.$container);
    ...
    value: function initWithdrawModal() {
      var $modalOpener = external_jQuery_default()('#withdraw_modal_opener', this.$container);
...
external_jQuery_default()(function () {
  return new YITH_WCAF_Shortcodes(external_jQuery_default()('.yith-wcaf'));
});
