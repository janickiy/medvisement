...
;// CONCATENATED MODULE: ./assets/js/admin/src/clicks.js
...
var YITH_WCAF_Clicks = /*#__PURE__*/function (_YITH_WCAF_Admin_Pane) {
  _inherits(YITH_WCAF_Clicks, _YITH_WCAF_Admin_Pane);
  var _super = _createSuper(YITH_WCAF_Clicks);
  function YITH_WCAF_Clicks() {
    _classCallCheck(this, YITH_WCAF_Clicks);
    return _super.call(this, external_jQuery_default()('#yith_wcaf_panel_affiliates-clicks'));
  }
  return _createClass(YITH_WCAF_Clicks);
}(YITH_WCAF_Admin_Panel);
external_jQuery_default()(function () {
  return new YITH_WCAF_Clicks();
});
...
/******/ })()
;
//# sourceMappingURL=yith-wcaf-clicks.bundle.js.map