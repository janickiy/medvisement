...
var YITH_WCAF_Commissions = /*#__PURE__*/function (_YITH_WCAF_Admin_Pane) {
  _inherits(YITH_WCAF_Commissions, _YITH_WCAF_Admin_Pane);
  var _super = _createSuper(YITH_WCAF_Commissions);
  function YITH_WCAF_Commissions() {
    var _this;
    _classCallCheck(this, YITH_WCAF_Commissions);
    var $containers = external_jQuery_default()('#yith_wcaf_panel_commissions-list').add('#yith_wcaf_panel_commission_details');
    _this = _super.call(this, $containers);
    _this.initNotes();
    return _this;
  }
  _createClass(YITH_WCAF_Commissions, [{
    key: "initNotes",
    value: function initNotes() {
      var $container = external_jQuery_default()('#commission_notes'),
        $objectID = external_jQuery_default()('#commission_id');
      if (!$container.length || !$objectID.length) {
        return;
      }
      new YITH_WCAF_Admin_Notes($container, 'commission', $objectID.val());
    }
  }]);
  return YITH_WCAF_Commissions;
}(YITH_WCAF_Admin_Panel);
external_jQuery_default()(function () {
  return new YITH_WCAF_Commissions();
});
...
/******/ })()
;
//# sourceMappingURL=yith-wcaf-commissions.bundle.js.map