...
class RenderErrorBoundary extends external_React_namespaceObject.Component {
  ...
  render() {
    return this.state.error ? /*#__PURE__*/external_React_namespaceObject.createElement(RouteContext.Provider, {
...
var asyncDataRequest = /*#__PURE__*/function () {
  ...
  _createClass(asyncDataRequest, [{
    ...
    key: "getData",
    value: function () {
      var _getData = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee(options) {
    ...
    value: function () {
      var _getFormattedData = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee2(query, dataType, args) {
        var options, answer;
...
function async_stats_request_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function async_stats_request_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? async_stats_request_ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : async_stats_request_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
...
var asyncStatsRequest = /*#__PURE__*/function (_asyncDataRequest) {
  ...
  _createClass(asyncStatsRequest, [{
    ...
    key: "getFormattedData",
    value: function () {
      var _getFormattedData = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee(query, dataType, args) {
        var _answer$data;
        ...
        return external_regeneratorRuntime_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              totals = answer === null || answer === void 0 || (_answer$data = answer.data) === null || _answer$data === void 0 ? void 0 : _answer$data.totals;
    ...
    key: "getIntervals",
    value: function () {
      var _getIntervals = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee2(answer, options) {
        var data, totalPages, intervals, pagedIntervals;
        return external_regeneratorRuntime_default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              data = answer.data, totalPages = answer.totalPages;
    ...
    value: function () {
      var _getPagedIntervals = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee3(answer, options) {
        var totalPages, promises, currentPage, pagedIntervals, pageAnswers, _iterator, _step, _pageAnswer$data, _pageAnswer$data2, pageAnswer;
        return external_regeneratorRuntime_default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              totalPages = answer.totalPages, promises = [];
            ...
            case 13:
              pagedIntervals = pagedIntervals.concat(pageAnswer === null || pageAnswer === void 0 || (_pageAnswer$data2 = pageAnswer.data) === null || _pageAnswer$data2 === void 0 ? void 0 : _pageAnswer$data2.intervals);
            case 14:
              _context3.next = 9;
              break;
            case 16:
...
var SubscriptionSummary = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SubscriptionSummary, [{
    ...
    value: function getValues(key, type) {
      var _stats$primary, _stats$secondary;
      var stats = this.props.stats;
      var primaryValue = stats === null || stats === void 0 || (_stats$primary = stats.primary) === null || _stats$primary === void 0 || (_stats$primary = _stats$primary.data) === null || _stats$primary === void 0 || (_stats$primary = _stats$primary.totals) === null || _stats$primary === void 0 ? void 0 : _stats$primary[key];
      var secondaryValue = stats === null || stats === void 0 || (_stats$secondary = stats.secondary) === null || _stats$secondary === void 0 || (_stats$secondary = _stats$secondary.data) === null || _stats$secondary === void 0 || (_stats$secondary = _stats$secondary.totals) === null || _stats$secondary === void 0 ? void 0 : _stats$secondary[key];
      return {
...
function DashboardChart_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function DashboardChart_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? DashboardChart_ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : DashboardChart_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
...
var DashboardChart = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DashboardChart, [{
    ...
    value: function getChartData() {
      ...
      return mode === 'item-comparison' ? this.getItemChartData() : this.getTimeChartData();
    }
  }, {
    ...
    value: function getTimeChartData() {
      ...
      var _getCurrentDates = (0,external_wc_date_namespaceObject.getCurrentDates)(query),
        ...
        intervals = stats === null || stats === void 0 || (_stats$primary = stats.primary) === null || _stats$primary === void 0 || (_stats$primary = _stats$primary.data) === null || _stats$primary === void 0 ? void 0 : _stats$primary.intervals;
      if (!intervals) {
        return [];
      }
      return intervals.map(function (interval, index) {
        var _stats$secondary, _secondaryData$interv, _secondaryInterval$su;
        var secondaryData = stats === null || stats === void 0 || (_stats$secondary = stats.secondary) === null || _stats$secondary === void 0 ? void 0 : _stats$secondary.data,
          secondaryInterval = secondaryData === null || secondaryData === void 0 || (_secondaryData$interv = secondaryData.intervals) === null || _secondaryData$interv === void 0 ? void 0 : _secondaryData$interv[index];
        var secondaryDate;
        ...
        return {
          ...
          secondary: {
            ...
            value: (secondaryInterval === null || secondaryInterval === void 0 || (_secondaryInterval$su = secondaryInterval.subtotals) === null || _secondaryInterval$su === void 0 ? void 0 : _secondaryInterval$su[selectedChart.key]) || 0
          }
        };
      });
    }
    ...
    value: function getItemChartData() {
      ...
      var intervals = stats === null || stats === void 0 || (_stats$primary2 = stats.primary) === null || _stats$primary2 === void 0 || (_stats$primary2 = _stats$primary2.data) === null || _stats$primary2 === void 0 ? void 0 : _stats$primary2.intervals;
      if (!intervals) {
        return [];
      }
      return intervals.map(function (interval) {
        ...
        var _iterator = DashboardChart_createForOfIteratorHelper(interval === null || interval === void 0 || (_interval$subtotals2 = interval.subtotals) === null || _interval$subtotals2 === void 0 ? void 0 : _interval$subtotals2.segments),
          _step;
        try {
    ...
    value: function getTimeChartTotals() {
      var _stats$primary3, _stats$secondary2;
      ...
      return {
        primary: stats === null || stats === void 0 || (_stats$primary3 = stats.primary) === null || _stats$primary3 === void 0 || (_stats$primary3 = _stats$primary3.data) === null || _stats$primary3 === void 0 || (_stats$primary3 = _stats$primary3.totals) === null || _stats$primary3 === void 0 ? void 0 : _stats$primary3[selectedChart.key],
        secondary: stats === null || stats === void 0 || (_stats$secondary2 = stats.secondary) === null || _stats$secondary2 === void 0 || (_stats$secondary2 = _stats$secondary2.data) === null || _stats$secondary2 === void 0 || (_stats$secondary2 = _stats$secondary2.totals) === null || _stats$secondary2 === void 0 ? void 0 : _stats$secondary2[selectedChart.key]
      };
    }
  }, {
    key: "getChartFormats",
    value: function getChartFormats() {
      ...
      return (0,external_wc_date_namespaceObject.getDateFormatsForInterval)(currentInterval, stats === null || stats === void 0 || (_stats$primary4 = stats.primary) === null || _stats$primary4 === void 0 || (_stats$primary4 = _stats$primary4.data) === null || _stats$primary4 === void 0 || (_stats$primary4 = _stats$primary4.intervals) === null || _stats$primary4 === void 0 ? void 0 : _stats$primary4.length);
    }
  }, {
    key: "getChartMode",
    value: function getChartMode() {
      var query = this.props.query;
      if ((query === null || query === void 0 ? void 0 : query.filter) === 'compare_affiliates' && !!(query !== null && query !== void 0 && query.affiliates)) {
  ...
  _createClass(DashboardStats, [{
    ...
    value: function requiresUpdate(newQuery, oldQuery) {
      ...
      for (var _i = 0, _noUpdateProps = noUpdateProps; _i < _noUpdateProps.length; _i++) {
        ...
        if (newQuery !== null && newQuery !== void 0 && newQuery[prop]) {
          delete newQuery[prop];
        }
        if (oldQuery !== null && oldQuery !== void 0 && oldQuery[prop]) {
          delete oldQuery[prop];
        }
      }
    ...
    key: "update",
    value: function () {
      var _update = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee(query) {
        var stats;
        return external_regeneratorRuntime_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    value: function getQueryArgs(query) {
      var queryArgs = query;
      if (query.filter === 'compare_affiliates') {
  ...
  _createClass(DashboardLeaderboard, [{
    ...
    value: function formatCell(column, row) {
      ...
      switch (column === null || column === void 0 ? void 0 : column.key) {
        case 'affiliate':
          var affiliateName = row === null || row === void 0 || (_row$extended_info = row.extended_info) === null || _row$extended_info === void 0 ? void 0 : _row$extended_info.name,
            affiliateAvatar = row === null || row === void 0 || (_row$extended_info2 = row.extended_info) === null || _row$extended_info2 === void 0 ? void 0 : _row$extended_info2.avatar,
            affiliateEmail = row === null || row === void 0 || (_row$extended_info3 = row.extended_info) === null || _row$extended_info3 === void 0 ? void 0 : _row$extended_info3.email,
        ...
        case 'product':
          var productName = row === null || row === void 0 ? void 0 : row.name,
            productImage = row === null || row === void 0 || (_row$extended_info4 = row.extended_info) === null || _row$extended_info4 === void 0 ? void 0 : _row$extended_info4.image,
...
var DashboardLeaderboards = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DashboardLeaderboards, [{
    ...
    value: function getConfig(items, config) {
      ...
      return leaderboards === null || leaderboards === void 0 || (_leaderboards$items = leaderboards[items]) === null || _leaderboards$items === void 0 ? void 0 : _leaderboards$items[config];
    }
  }, {
    key: "render",
    value: function render() {
...
function DashboardController_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function DashboardController_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? DashboardController_ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : DashboardController_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
...
var DashboardRoutedController = function DashboardRoutedController(props) {
  ...
  var match = useMatch(location.pathname);
