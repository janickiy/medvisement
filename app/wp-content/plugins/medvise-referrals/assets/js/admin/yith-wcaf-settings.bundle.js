...
var YITH_WCAF_Admin_Table = /*#__PURE__*/function () {
  function YITH_WCAF_Admin_Table($context, args) {
    ...
    var $table = external_jQuery_default()('table.wp-list-table', $context);
    if (!$table.length) {
      $table = external_jQuery_default()('.no-items-found', $context);
    }
    if (!$table.length) {
      return;
    }
  ...
  _createClass(YITH_WCAF_Admin_Table, [{
    ...
    value: function replaceTable(newTable) {
      var $newTable = external_jQuery_default()(newTable).find('table');
      if (!$newTable.length) {
        return;
      }
  ...
  _createClass(YITH_WCAF_Admin_Actions_Table, [{
    ...
    value: function initCloneButtons() {
      ...
      this.$context.on('click', '.clone a', function (ev) {
        ev.preventDefault();
        self.doButtonAction('clone', external_jQuery_default()(this));
      });
    }
  }, {
    ...
    value: function initDeleteButtons() {
      ...
      this.$context.on('click', '.delete a', function (ev) {
        ...
        globals_confirm().then(function () {
          self.doButtonAction('delete', external_jQuery_default()(_this2), function ($row) {
            return $row.remove();
          });
        });
      });
    ...
    value: function initRestoreDefaultButton() {
      var _this4 = this;
      external_jQuery_default()('#restore_defaults', this.$context).on('click', function (ev) {
    ...
    value: function getModalOpeners() {
      return external_jQuery_default()('.edit', this.$table).add('#add_field', this.$context).add('.yith-add-button', this.$context);
    }
  }, {
  ...
  _createClass(YITH_WCAF_Add_Profile_Field_Modal, [{
    ...
    value: function initOptionsTable() {
      ...
      $optionsTable.on('click', '.delete', function (ev) {
        ev.preventDefault();
        external_jQuery_default()(this).closest('tr').remove();
      });
    ...
    value: function initCarbonCopyFields() {
      ...
      $fields.on('keydown', function () {
        ...
        $copy_fields.each(function () {
          var $copy_field = external_jQuery_default()(this),
            target = $copy_field.data('copy-target'),
            $target = external_jQuery_default()(target, self.modal.elements.content);
...
var YITH_WCAF_Admin_Ajax_Modal = /*#__PURE__*/function (_YITH_WCAF_Admin_Moda) {
  ...
  _createClass(YITH_WCAF_Admin_Ajax_Modal, [{
    key: "onOpen",
    value: function () {
      var _onOpen = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee() {
        var template;
        ...
        return external_regeneratorRuntime_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              $form = external_jQuery_default()('<form/>'), $content = this.modal.elements.content;
              $content.children().wrapAll($form);

              // append save button to modal content
              $pSubmit = external_jQuery_default()('<p/>', {
                "class": 'form-row submit'
              }), $submitButton = external_jQuery_default()('<button/>', {
...
var YITH_WCAF_Gateways_Table = /*#__PURE__*/function (_YITH_WCAF_Admin_Tabl) {
  ...
  _createClass(YITH_WCAF_Gateways_Table, [{
    ...
    key: "getModalOpeners",
    value: function getModalOpeners() {
      return external_jQuery_default()('.edit', this.$table);
    }
  }]);
...
var YITH_WCAF_Settings = /*#__PURE__*/function () {
  function YITH_WCAF_Settings() {
    ...
    external_jQuery_default()(document).on('click', '#yith-plugin-fw-float-save-button', function (ev) {
      var $form = external_jQuery_default()('#plugin-fw-wc'),
  ...
  _createClass(YITH_WCAF_Settings, [{
    ...
    value: function initAffiliateProfileFieldsTable() {
      var $context = external_jQuery_default()('#yith_wcaf_profile_fields');
      new YITH_WCAF_Profile_Fields_Table($context);
    }
  }, {
    key: "initGatewaysTable",
    value: function initGatewaysTable() {
      var $context = external_jQuery_default()('#yith_wcaf_gateways'),
        $table = external_jQuery_default()('table.gateways', $context);
      if ($table.length) {
