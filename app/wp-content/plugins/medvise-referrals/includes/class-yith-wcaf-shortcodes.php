...
if ( ! class_exists( 'YITH_WCAF_Shortcodes' ) ) {
	...
	class YITH_WCAF_Shortcodes {
		...
		public static function init() {
			...
			// скрываем страницу партнерки
			add_action( 'template_redirect', [ static::class, 'hide_dashboard_from_users' ] );
		}
		...
		public static function hide_dashboard_from_users() {

			if ( ! is_page( 'affiliate-dashboard' ) ) {
				return true;
			}
