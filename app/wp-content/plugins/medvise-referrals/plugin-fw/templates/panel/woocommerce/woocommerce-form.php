	...
	<div class="<?php echo esc_attr( $content_class ); ?>">
		<form id="plugin-fw-wc" method="<?php echo esc_attr( $form_method ); ?>">
			...
			<?php if ( apply_filters( 'yit_framework_show_float_save_button', true ) ) : ?>
				<button id="yith-plugin-fw-float-save-button" class="button button-primary yith-plugin-fw-animate__appear-from-bottom" data-default-label="<?php esc_attr_e( 'Save Options', 'yith-plugin-fw' ); ?>" data-saved-label="Настройки сохранены!"><?php esc_html_e( 'Save Options', 'yith-plugin-fw' ); ?></button>
			<?php endif; ?>
