        ...
        steps: [
            {
                ...
                popover: {
                    ...
                    onNextClick: () => {
                        $('#substance-tree').removeAttr('open');
            ...
            },
            {
                element: '#substance-tree',
                popover: {
                    description: 'Древо - это структура, которая поможет сориентироваться по группам препаратов и в каких областях применяются те или иные препараты.',
                    align: 'center',
                    side: 'bottom',
                    onNextClick: () => {
                        $('#substance-tree').attr('open', 'open');
