...
- **Body (JSON)**:
  ...
  - `article_type_slug` (string, optional) — таксономия `article-type`, термин создаётся автоматически, если его нет
...
- Устанавливает таксономии (`article-type`, `age`, `symptoms`, `specialty`)
